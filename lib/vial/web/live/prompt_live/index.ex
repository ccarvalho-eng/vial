defmodule Vial.Web.PromptLive.Index do
  @moduledoc """
  ...
  def handle_event("search", %{"search" => %{"query" => query}}, socket) do
    {:noreply,
     push_patch(socket,
       to: vial_path("prompts", build_query_params(query, socket.assigns.selected_tags))
     )}
  end
  ...
  def handle_event("toggle_tag", %{"tag" => tag}, socket) do
    ...
    {:noreply,
     push_patch(socket,
       to: vial_path("prompts", build_query_params(socket.assigns.search_query, selected_tags))
     )}
  end

  @impl Phoenix.LiveView
  def handle_event("clear_filters", _params, socket) do
    {:noreply, push_patch(socket, to: vial_path("prompts"))}
  end
