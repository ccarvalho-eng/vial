defmodule Aludel.Interfaces.Storage.Adapters.GCS do
  @moduledoc """
  ...
  alias Aludel.Interfaces.Storage.Adapters.GCS.GoogleApiClient
  ...
  defp client(config), do: Keyword.get(config, :client, GoogleApiClient)
